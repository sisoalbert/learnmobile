...
// Babel's complete AST shape is intentionally hidden behind these narrow runtime guards.
// The preview accepts only a small, static subset and never evaluates AST nodes.
